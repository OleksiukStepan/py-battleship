...
if __name__ == "__main__":
    ...
    battle = Battleship(shipss)
    # battle.print_field()
    # battle.add_ships_to_the_field()
    # battle.print_field()
    # battle.fire((0, 0))
    # battle.fire((0, 1))
    # battle.fire((0, 2))
    ...
    # battle.fire((0, 4))
    # print(battle.field)
    print(battle.fire((0, 4)))  # == "Miss!"
    print(battle.fire((1, 7)))  # == "Miss!"
    print(battle.fire((2, 0)))  # == "Hit!"
    print(battle.fire((2, 1)))  # == "Hit!"
    print(battle.fire((2, 2)))  # == "Hit!"
    print(battle.fire((2, 3)))  # == "Sunk!"
    print(battle.fire((4, 3)))  # == "Miss!"
    print(battle.fire((4, 5)))  # == "Hit!"
    print(battle.fire((5, 5)))  # == "Miss!"
    print(battle.fire((4, 6)))  # == "Sunk!"
    print(battle.fire((9, 5)))  # == "Sunk!"
    print(battle.fire((9, 6)))  #
    pass
